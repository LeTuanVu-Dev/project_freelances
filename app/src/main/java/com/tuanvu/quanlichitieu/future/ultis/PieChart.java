...
public class PieChart extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                textColor = array.getColor(R.styleable.PieChart_textColor, Color.BLACK);
                ...
                textSize = array.getFloat(R.styleable.PieChart_textSize, 30f);
                aboutTextSize = array.getFloat(R.styleable.PieChart_aboutTextSize, 30f);
